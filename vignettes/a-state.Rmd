...
The data was scraped from the US Bureau of Labor Statistics (BLS) Local Area Unemployment Statistics (LAUS) webpage on January 2, 2014 (http://www.bls.gov/lau/). For the purposes of reproducbility, the scripts which scarped the data also ship with this package - see function `build_state_df` for details.
